...
const ProjectionsPage = () => {
    ...
    const portfolioColumns = [
        { title: 'Asset Class', dataIndex: 'name', key: 'name', width: '20%' },
        {
        ...
        {
            title: `Target % (${riskProfiles[riskLevel]?.name || '...'} Risk)`,
        ...
        {
            title: 'New Allocated Value (₹)',
            dataIndex: 'newAllocatedValue',
            key: 'newAllocatedValue',
            width: '15%',
            render: (_, record) => {
                const newValue = (currentTotalValue * (record.targetAllocation / 100)) || 0;
                return `₹ ${formatIndianNumber(newValue)}`;
            },
        },
        {
            title: 'Action',
